...
!(function (a, b) {
				...
				while (j--)
					(h = Y.exec(b[j]) || []),
						...
						n &&
							...
							(l = o.event.special[n] || {}),
							(k = o.extend({ type: n, origType: q, data: d, handler: c, guid: c.guid, selector: e, needsContext: e && o.expr.match.needsContext.test(e), namespace: p.join(".") }, f)),
							(m = i[n]) || ((m = i[n] = []), (m.delegateCount = 0), (l.setup && l.setup.call(a, d, p, g) !== !1) || (a.addEventListener && a.addEventListener(n, g, !1))),
		...
		trigger: function (b, c, d, e) {
			...
			if (
				...
				3 !== d.nodeType &&
					...
					(q.indexOf(".") >= 0 && ((r = q.split(".")), (q = r.shift()), r.sort()), (k = q.indexOf(":") < 0 && "on" + q), (b = b[o.expando] ? b : new o.Event(q, "object" == typeof b && b)), (b.isTrigger = e ? 2 : 3), (b.namespace = r.join(".")), (b.namespace_re = b.namespace ? new RegExp("(^|\\.)" + r.join("\\.(?:.*\\.|)") + "(\\.|$)") : null), (b.result = void 0), b.target || (b.target = d), (c = null == c ? [b] : o.makeArray(c, [b])), (n = o.event.special[q] || {}), e || !n.trigger || n.trigger.apply(d, c) !== !1))
			) {
	...
	(o.Animation = o.extend(Xb, {
		...
		(o.speed = function (a, b, c) {
			...
			return (
				(d.duration = o.fx.off ? 0 : "number" == typeof d.duration ? d.duration : d.duration in o.fx.speeds ? o.fx.speeds[d.duration] : o.fx.speeds._default),
		...
		ajax: function (a, b) {
			...
			function x(a, b, f, h) {
				...
				2 !== t &&
					...
					f && (u = uc(k, v, f)),
					(u = vc(k, u, v, j)),
					j ? (k.ifModified && ((w = v.getResponseHeader("Last-Modified")), w && (o.lastModified[d] = w), (w = v.getResponseHeader("etag")), w && (o.etag[d] = w)), 204 === a || "HEAD" === k.type ? (x = "nocontent") : 304 === a ? (x = "notmodified") : ((x = u.state), (r = u.data), (s = u.error), (j = !s))) : ((s = x), (a || !x) && ((x = "error"), 0 > a && (a = 0))),
					(v.status = a),
					(v.statusText = (b || x) + ""),
	...
	o.ajaxSetup({
		...
		o.ajaxPrefilter("json jsonp", function (b, c, d) {
			...
			return h || "jsonp" === b.dataTypes[0]
				? ((e = b.jsonpCallback = o.isFunction(b.jsonpCallback) ? b.jsonpCallback() : b.jsonpCallback),
